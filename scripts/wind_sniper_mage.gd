...
var bomb = preload("res://scenes/projectiles/wind_projectile.tscn")
func _on_timer_timeout() -> void:
	if player:
		...
		bomb_inst.fire((direction + spread).normalized(), 750)
